...
JGO.BOARD.medium = {
    textures: {
        black: 'js/vendor/medium/black.png',
        white: 'js/vendor/medium/white.png',
        shadow:'js/vendor/medium/shadow.png',
        board: 'js/vendor/medium/shinkaya.jpg'
    },
...
JGO.BOARD.mediumWalnut = JGO.util.extend(JGO.util.extend({}, JGO.BOARD.medium), {
    textures: {board: 'js/vendor/medium/walnut.jpg', shadow: 'js/vendor/medium/shadow_dark.png'},
